        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20 mb-6">
              ...
              <span className="text-sm text-white/90">Disponível agora</span>
            </div>
            ...
            >
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">Resposta rápida</div>
                <div className="text-sm text-white/60">Em até 1 hora</div>
              </div>
              <div className="hidden sm:block w-px h-16 bg-white/10" />
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">100% Seguro</div>
                <div className="text-sm text-white/60">Dados protegidos</div>
              </div>
              <div className="hidden sm:block w-px h-16 bg-white/10" />
              <div className="text-center">
                <div className="text-2xl font-bold text-white mb-1">Sem compromisso</div>
                <div className="text-sm text-white/60">Tire suas dúvidas</div>
              </div>
            </motion.div>
          </motion.div>
        </div>
